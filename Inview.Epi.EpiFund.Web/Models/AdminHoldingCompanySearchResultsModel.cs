...
{
	public class AdminHoldingCompanySearchResultsModel
	{

		[Display(Name = "Name of Holding Co")]
		public string HCName { get; set; }

		[Display(Name = "HC = RA")]
		public bool ISRA { get; set; }

		[Display(Name = "Holding Co e mail")]
		public string HCEmail { get; set; }

		[Display(Name = "First Name of HC Officer")]
		public string HCFirstName { get; set; }

		[Display(Name = "Last Name of HC Officer")]
		...
		public AdminHoldingCompanySearchResultsModel()
		{
			this.States = Common.GetSelectListItemsOfStates(true);
		}

		public PagedList.IPagedList<HoldingCompanyList> HcList { get; set; }
