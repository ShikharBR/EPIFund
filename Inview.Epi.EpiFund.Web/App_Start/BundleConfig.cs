...
namespace Inview.Epi.EpiFund.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/dropzonescriptsa").Include(
                     "~/Scripts/dropzone/dropzone.js",
                     "~/Scripts/dropzone/app.js"));

            bundles.Add(new ScriptBundle("~/bundles/dropzonescriptsh").Include(
                     "~/Scripts/dropzone/dropzone.js",
                     "~/Scripts/dropzone/Home.js"));
