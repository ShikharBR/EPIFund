...
namespace Inview.Epi.EpiFund.Domain.ViewModel
{
	public class UserModel
	{
		...
		public Inview.Epi.EpiFund.Domain.Enum.UserType ControllingUserType
		{
			get;
			set;
		}
		...
		[Display(Name="Has Seller Privilege?")]
		public bool HasSellerPrivilege
		{
			get;
			set;
		}
		...
		[Display(Name="Industrial Tenant Property")]
		...
		[Display(Name="Mobile Home Parks")]
		...
		[Display(Name="Mixed Use CRE Property")]
		...
		[Display(Name="CRE Secured Paper")]
		...
		[Display(Name="Preferred Contact Times")]
		...
		public string SelectedPreferredContactTimesString
		{
			get;
			set;
		}
		...
		public string SelectedPreferredMethodsString
		{
			get;
			set;
		}
		...
		public Inview.Epi.EpiFund.Domain.Enum.UserType SelectedUserType
		{
			get;
			set;
		}

		public bool SignedICAgreement
		{
			get;
			set;
		}

		public bool SignedNCND
		{
			get;
			set;
		}

		[Display(Name="Single Tenant Retail Property")]
		...
		public List<UserFileModel> UserFiles
		{
			get;
			set;
		}
		...
		public List<UserNoteModel> UserNotes
		{
			get;
			set;
		}
		...
		public UserModel()
		{
			...
			SelectListItem selectListItem = new SelectListItem()
			{
				Selected = false,
				Text = "CRE Mtg Broker",
				Value = Inview.Epi.EpiFund.Domain.Enum.UserType.CREBroker.ToString()
			};
			...
			SelectListItem selectListItem10 = new SelectListItem()
			{
				Selected = false,
				Text = "CRE Mtg Lender",
				Value = Inview.Epi.EpiFund.Domain.Enum.UserType.CRELender.ToString()
			};
			...
			SelectListItem selectListItem11 = new SelectListItem()
			{
				...
				Value = Inview.Epi.EpiFund.Domain.Enum.UserType.Investor.ToString()
			};
			...
			SelectListItem selectListItem12 = new SelectListItem()
			{
				...
				Value = Inview.Epi.EpiFund.Domain.Enum.UserType.CREOwner.ToString()
			};
			...
			SelectListItem selectListItem13 = new SelectListItem()
			{
				...
				Value = Inview.Epi.EpiFund.Domain.Enum.UserType.CREMtgNoteOwner.ToString()
			};
			...
			SelectListItem selectListItem14 = new SelectListItem()
			{
				Selected = false,
				Text = "IC Participant",
				Value = Inview.Epi.EpiFund.Domain.Enum.UserType.ICAdmin.ToString()
			};
			selectListItems1.Add(selectListItem14);
			SelectListItem selectListItem15 = new SelectListItem()
			{
				Value = Inview.Epi.EpiFund.Domain.Enum.UserType.ListingAgent.ToString(),
				Text = "NAR Member"
			};
