...
{
	public class ICAgreementTemplateModel
	{
		[Display(Name="Acronym of Corporate Entity")]
		public string AcronymOfCorporateEntity
		{
			get;
			set;
		}
		...
		[Display(Name="Registrant/Corporate Title")]
		[Required]
		...
		public string ExpirationYear
		{
			...
			{
				string str;
				if (this.ExpireYear.ToString().Length == 4)
				{
					int expireYear = this.ExpireYear;
					str = expireYear.ToString().Substring(2, 2);
				}
				else
				{
					str = this.ExpireYear.ToString();
				}
				return str;
			}
		}
		...
		public int ExpireDay
		{
			get
			{
				return DateTime.Now.AddDays(30).Day;
			}
		}
		...
		public string ExpireMonth
		{
			get
			{
				return DateTime.Now.AddDays(30).ToString("MMMM");
			}
		}
		...
		public string FullName
		{
			get
			{
				return string.Concat(this.UserFirstName, " ", this.UserLastName);
			}
		}
		...
		[Display(Name="Operating Corporate Name")]
		public string OperatingCorporateName
		{
			get;
			set;
		}
		...
		[Display(Name="Registrant Address Line 1")]
		[Required]
		...
		[Display(Name="Registrant Address Line 2")]
		...
		public string YearFormatted
		{
			get
			{
				...
				{
					int year = this.Year;
					str = year.ToString().Substring(2, 2);
				}
				else
				{
		...
		public ICAgreementTemplateModel()
		{
