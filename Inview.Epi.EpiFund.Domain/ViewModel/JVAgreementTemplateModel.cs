...
{
	public class JVAgreementTemplateModel
	{
		...
		public string Initials
		{
			get
			{
				string str = string.Concat(this.UserFirstName.Substring(0, 1), ".", this.UserLastName.Substring(0, 1));
				return str;
			}
		}
		...
		public JVAgreementTemplateModel()
		{
